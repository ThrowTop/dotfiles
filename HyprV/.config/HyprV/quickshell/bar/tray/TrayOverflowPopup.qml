...
Item {
    ...
    readonly property int popupWidth: shellRoot ? (popupPadding * 2 + columnCount * shellRoot.trayButtonWidth + Math.max(0, columnCount - 1) * shellRoot.trayButtonSpacing) : 0
    readonly property int popupHeight: shellRoot ? (popupPadding * 2 + rowCount * shellRoot.trayButtonHeight) : 0
    ...
    PanelWindow {
        ...
        Rectangle {
            ...
            Grid {
                ...
                columnSpacing: shellRoot ? shellRoot.trayButtonSpacing : 0
                rowSpacing: 0
                ...
                Repeater {
                    ...
                    delegate: TrayButton {
                        ...
                        width: shellRoot ? shellRoot.trayButtonWidth : 18
                        height: shellRoot ? shellRoot.trayButtonHeight : 18
                        shellRoot: overflowPopupRoot.shellRoot
                        trayItem: modelData
