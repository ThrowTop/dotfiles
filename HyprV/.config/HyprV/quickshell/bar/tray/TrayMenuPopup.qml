...
Item {
    ...
    property int textPixelSize: shellRoot ? shellRoot.trayMenuTextPixelSize : 13
    ...
    readonly property color hoverFill: shellRoot ? shellRoot.withAlpha(shellRoot.primaryText, shellRoot.darkMode ? 0.10 : 0.12) : "transparent"
                ...
                Column {
                    ...
                    Rectangle {
                        ...
                        Text {
                            ...
                            text: "< Back"
                            color: shellRoot ? shellRoot.primaryText : "#cdd6f4"
                        ...
                        delegate: Rectangle {
                            ...
                            Item {
                                ...
                                Text {
                                    ...
                                    anchors.verticalCenter: parent.verticalCenter
                                    text: menuEntry?.text || ""
                                    color: (shellRoot && menuEntry?.enabled === false) ? shellRoot.withAlpha(shellRoot.primaryText, 0.55) : (shellRoot ? shellRoot.primaryText : "#cdd6f4")
                                    font.family: shellRoot ? shellRoot.baseFont : "JetBrainsMono Nerd Font"
                                    font.pixelSize: trayMenuPopupRoot.textPixelSize
