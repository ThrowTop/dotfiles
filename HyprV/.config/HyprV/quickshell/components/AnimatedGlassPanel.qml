...
Item {
    ...
    function prepareOpenAnimation() {
        ...
        console.log("[AGP] prepareOpenAnimation: revealHeight=0, fullPanelHeight=" + fullPanelHeight);
    }

    function playOpenAnimation() {
        stopAnimations();
        console.log("[AGP] playOpenAnimation: fullPanelHeight=" + fullPanelHeight + " revealHeight=" + revealHeight);
