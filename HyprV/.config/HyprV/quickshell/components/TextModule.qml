...
Item {
    ...
    property color textColor: shellRoot ? shellRoot.primaryText : "#cdd6f4"
    property string fontFamily: shellRoot ? shellRoot.baseFont : "JetBrainsMono Nerd Font"
    ...
    property color highlightedTextColor: shellRoot ? shellRoot.activeWorkspaceText : "#1e1e2e"
    ...
    Rectangle {
        ...
        color: highlighted ? module.highlightColor : (shellRoot ? shellRoot.workspaceHoverBackground : "transparent")
